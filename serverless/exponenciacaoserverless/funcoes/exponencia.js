...
const instanciaBucket = instanciaStorage.bucket('opexponenciacao');


module.exports = async function exponencia(evento){
    try{
        ...
        const fileName = `exponenciacao_${timestamp}.json`
